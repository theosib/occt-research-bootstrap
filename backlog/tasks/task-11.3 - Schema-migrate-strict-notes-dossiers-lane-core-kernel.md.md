---
id: task-11.3
title: 'Schema migrate (strict): notes/dossiers/lane-core-kernel.md'
status: Done
assignee: []
...
schema_migration_target: notes/dossiers/lane-core-kernel.md
...
- headings: ['# Dossier: Core kernel (Standard / NCollection / gp / Geom / Geom2d / math)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Core kernel (Standard / NCollection / gp / Geom / Geom2d / math)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Core kernel (Standard / NCollection / gp / Geom / Geom2d / math)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/dossiers/lane-core-kernel.md` passes `strict` validation
<!-- AC:END -->
