---
id: task-11.2
title: 'Schema migrate (strict): notes/dossiers/lane-brep-geometry-bridge.md'
status: Done
assignee: []
...
schema_migration_target: notes/dossiers/lane-brep-geometry-bridge.md
...
- headings: ['# Dossier: B-Rep geometry bridge (BRep / BRepTools / BRepAdaptor / BRepBuilderAPI)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: B-Rep geometry bridge (BRep / BRepTools / BRepAdaptor / BRepBuilderAPI)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: B-Rep geometry bridge (BRep / BRepTools / BRepAdaptor / BRepBuilderAPI)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/dossiers/lane-brep-geometry-bridge.md` passes `strict` validation
<!-- AC:END -->
