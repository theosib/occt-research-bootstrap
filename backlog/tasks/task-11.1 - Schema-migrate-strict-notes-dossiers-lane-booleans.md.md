---
id: task-11.1
title: 'Schema migrate (strict): notes/dossiers/lane-booleans.md'
status: Done
assignee: []
...
schema_migration_target: notes/dossiers/lane-booleans.md
...
- headings: ['# Dossier: Booleans (BOPAlgo / BOPDS / BRepAlgoAPI)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Booleans (BOPAlgo / BOPDS / BRepAlgoAPI)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Booleans (BOPAlgo / BOPDS / BRepAlgoAPI)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/dossiers/lane-booleans.md` passes `strict` validation
<!-- AC:END -->
