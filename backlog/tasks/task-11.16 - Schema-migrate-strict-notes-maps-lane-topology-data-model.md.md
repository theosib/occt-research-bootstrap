---
id: task-11.16
title: 'Schema migrate (strict): notes/maps/lane-topology-data-model.md'
status: Done
assignee: []
...
schema_migration_target: notes/maps/lane-topology-data-model.md
...
- headings: ['# Lane map: topology-data-model', '## Package footprint (size proxy)', '## Core types / entry points (with code citations)', '## Include graph evidence (who pulls these packages in)', '## Local dependency shape (what these packages depend on)', '## Suggested dossier entry points (next task)'] does not contain items matching the given schema
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/maps/lane-topology-data-model.md` passes `strict` validation
<!-- AC:END -->
