---
id: task-11.6
title: 'Schema migrate (strict): notes/dossiers/lane-shape-healing-analysis.md'
status: Done
assignee: []
...
schema_migration_target: notes/dossiers/lane-shape-healing-analysis.md
...
- headings: ['# Dossier: Shape healing + analysis (ShapeFix / ShapeAnalysis / ShapeUpgrade)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Shape healing + analysis (ShapeFix / ShapeAnalysis / ShapeUpgrade)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Shape healing + analysis (ShapeFix / ShapeAnalysis / ShapeUpgrade)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/dossiers/lane-shape-healing-analysis.md` passes `strict` validation
<!-- AC:END -->
