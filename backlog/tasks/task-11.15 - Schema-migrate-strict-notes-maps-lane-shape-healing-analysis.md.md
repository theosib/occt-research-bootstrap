---
id: task-11.15
title: 'Schema migrate (strict): notes/maps/lane-shape-healing-analysis.md'
status: Done
assignee: []
...
schema_migration_target: notes/maps/lane-shape-healing-analysis.md
...
- headings: ['# Lane map: shape-healing-analysis', '## Package footprint (size proxy)', '## Core types / entry points (with code citations)', '## Include graph evidence (who pulls these packages in)', '## Local dependency shape (what these packages depend on)', '## Suggested dossier entry points (next task)'] does not contain items matching the given schema
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/maps/lane-shape-healing-analysis.md` passes `strict` validation
<!-- AC:END -->
