---
id: task-11.5
title: 'Schema migrate (strict): notes/dossiers/lane-meshing.md'
status: Done
assignee: []
...
schema_migration_target: notes/dossiers/lane-meshing.md
...
- headings: ['# Dossier: Meshing (BRepMesh / IMeshTools / IMeshData)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Meshing (BRepMesh / IMeshTools / IMeshData)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
- headings: ['# Dossier: Meshing (BRepMesh / IMeshTools / IMeshData)', '## Purpose', '## High-level pipeline', '## Key classes/files', '## Core data structures + invariants', '## Tolerance / robustness behaviors (observed)', '## Runnable repro (optional)', '## Compare to papers / alternatives'] does not contain items matching the given schema
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `notes/dossiers/lane-meshing.md` passes `strict` validation
<!-- AC:END -->
